    ...
    <table class="custom-table">
        ...
        <tbody>
            <tr v-for="item in items" :key="item.id">
                ...
                <td>
                    <button class="action-btn delete-btn" @click="deleteOne(item.datecreated)"><i class="fas fa-trash-alt"></i> Delete</button>
                    <button class="action-btn update-btn" @click="update(item.datecreated)"><i class="fas fa-pencil-alt"></i> Update</button>
                </td>
            </tr>
        </tbody>
    </table>
